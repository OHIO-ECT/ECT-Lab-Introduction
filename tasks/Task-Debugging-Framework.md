...
The student configured R1 and PC1 in a previous session. Today, PC1 cannot reach the Internet (`ping 8.8.8.8` fails), but PC1 can still ping R1's `eth0` interface address (10.0.0.254).
