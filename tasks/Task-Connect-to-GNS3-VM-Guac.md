...
8. Once connected into your gHost look at the files on the destktop. There should be a file with your gHost's name. Inside that file is information about your gHost including:
    ...
    - Username
    - Password<br>
Note: The NAME of your gHost VM is VERY IMPORTANT as it contains the unique identifier for your VM. This is especially important when multiple classes are using GNS3 VMs. <br>
